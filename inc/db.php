...
class DB
{
  ...
  private $db_user = "wsenet_root";
  private $db_pass = 'b;NmFYo!OkZC';
  private $db_name = "wsenet_db";
...
<!doctype html>
<title>Light | Site Maintenance</title>
<style>
html, body{
  margin: 0 auto;
...
<main>
  ...
  <a href="mailto:admin@lightstore.com">admin@lightstore.com</a>
</main>
<footer><strong>Light Managment</strong></footer>
<?php
	exit();
}
?>
